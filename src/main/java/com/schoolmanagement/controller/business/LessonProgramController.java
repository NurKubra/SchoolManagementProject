...
public class LessonProgramController {
    ...
    public List<LessonProgramResponse> getAllLessonProgramByList() { //status code setlemeyeciz default olan doncek
    ...
    //frontend kisminda idler den ziyade matematik, kimya gibi kisimlara tiklayinca arka planda id ile cagrilir, kullanici db deki
    //id yi bilmez
    //PathVariable ile birden fazla veri almak istersek parantez icinde hangi veri oldugunu belirtmeliyliz.
