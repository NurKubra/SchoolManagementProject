...
public class TeacherController {
    ...
    public List<TeacherResponse>  getTeacherByName(@RequestParam (name = "name") String teacherName){  //birden fazla isim geelbilir o yuzden list (ayniisimli )
    ...
    //not: update methodunda tum fiedlar (requestde)yeniden atanmali atanmazsa null olur


    // ögretmeni lessonPrograma ekleyebilmek icin

    // Not: addLessonProgramsToTeachersLessonsProgram() **********************************
    @PreAuthorize("hasAnyAuthority('ADMIN','MANAGER','ASSISTANT_MANAGER')")
    @PostMapping("/chooseLesson")  // http://localhost:8080/teachers/chooseLesson  + POST  //burda put ya da patchmapping ile yapmak yerine PostMAPPING kullandik
    ...
    //set yapida lessonProgramId'ler ekleyecegim icin RequestBody ile aliyorum , bunu karsilayack bir class olusturuyorum
}
